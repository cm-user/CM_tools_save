        ...
        success: function (result) {
            ...
            $.each(result, function (key, val) {
                ...
                if(val['temps'] != undefined){
                    ...
                    $elem += "<div class=\"col-3\" align=\"center\">";
                    $elem += "<a href=\"#\" data-toggle=\"modal\" data-target=\"#Modal_Picture_" + val['id'] + "\"><img src=\"" + val['path-jpg'] + " \" width=\'300\'></a>";
                    // $elem += "<br>";
...
function DisplayPicture(data) {
    ...
    $.each(data, function (key, val) {
        ...
        if(val['temps'] != undefined){
            ...
            $elem += "<div class=\"col-4\" align=\"center\">";
            $elem += "<div id=\'click_machine_" + val['id'] + "\' class=\'alert alert-danger\'>";
            $elem += "<a href=\"#\" data-toggle=\"modal\" data-target=\"#Modal_Picture_" + val['id'] + "\"><img src=\"" + val['path-jpg'] + " \" width=\'450\'></a>";
            $elem += "<div class=\"row\">";
