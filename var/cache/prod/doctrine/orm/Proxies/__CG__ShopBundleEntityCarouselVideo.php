 ...
 */
class CarouselVideo extends \ShopBundle\Entity\CarouselVideo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'position', 'videoId', 'dateStart', 'dateEnd', 'type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CarouselVideo $proxy) {
    ...
    public function setVideoId($videoId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVideoId', [$videoId]);
