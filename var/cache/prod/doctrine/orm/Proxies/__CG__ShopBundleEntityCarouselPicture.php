 ...
 */
class CarouselPicture extends \ShopBundle\Entity\CarouselPicture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'position', 'length', 'filePicture', 'picture', 'dateStart', 'dateEnd', 'type'];
        }
