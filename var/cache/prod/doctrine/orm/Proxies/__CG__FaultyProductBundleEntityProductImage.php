 ...
 */
class ProductImage extends \FaultyProductBundle\Entity\ProductImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'filePicture', 'picture', 'product'];
        }
