...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('BWNzrfdID8', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TxTUB8gYCL', 0, 'DE1NdAayGw02W9cwINfX6I', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_CmConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('marketingbundle.doctrine_product_listener'));
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('faulty.doctrine_banner_listener'));
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('shop.doctrine_banner_listener'));
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('marketingbundle.doctrine_banner_listener'));
        $a->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.cm_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.cm_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'cadeaumaestro_prod', 'user' => 'cadeau_prod', 'password' => 'Jnd671fARFv12', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Dbal_MarketingConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('shop.doctrine_banner_listener'));
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('marketingbundle.doctrine_banner_listener'));
        $a->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.marketing_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.marketing_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'cm_divers', 'user' => 'cm_divers', 'password' => 'FVezV1RvEZA', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_CmMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_cm_e6116bc01afe5fbc59d89c0168c847e32e1bee65033da980935c0584717c4c1b');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_MarketingMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_marketing_e6116bc01afe5fbc59d89c0168c847e32e1bee65033da980935c0584717c4c1b');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('PMjM-dOWok', NULL, 'DE1NdAayGw02W9cwINfX6I', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.user_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_UserSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.user_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($t, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($c, array(0 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b)), 1 => $b), 'user', $a, $d, $e), 2 => $v, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($c, $h, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $u, 'user_secured_area', $w, $x, array('check_path' => '/user/login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($c, '594bd53dd4fe82.68318645', $a, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($c, ${($_ = isset($this->services['security.access.decision_manager']) ? $this->services['security.access.decision_manager'] : $this->getSecurity_Access_DecisionManagerService()) && false ?: '_'}, $t, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($c, $e, $u, 'user_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $u, '/user/login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('user_secured_area', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.chain_provider', 'user', 'security.authentication.form_entry_point.user_secured_area', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'MarketingBundle:Form:field.html.twig'), 'debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TFduGU5pL+', 0, 'DE1NdAayGw02W9cwINfX6I', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y5+kmJmflI', 0, 'DE1NdAayGw02W9cwINfX6I', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'RobertoTruToInlineStyleEmailBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/robertotru/to-inline-style-email-bundle'),
                ...
                'TinypngBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/loevgaard/tinypng-bundle'),
            ...
            case 'folder_img': $value = ($this->targetDirs[3].'/app/../../www/img/newsletter/news/'); break;
            case 'folder_upload': $value = ($this->targetDirs[3].'/app/../web/upload/'); break;
            case 'folder_img_base': $value = ($this->targetDirs[3].'/app/../../www/img/'); break;
            case 'folder_cm_base': $value = ($this->targetDirs[3].'/app/../../www/'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'url_img' => 'https://www.cadeau-maestro.com/img/newsletter/news/',
            'url_upload' => 'http://tools.cadeau-maestro.com/upload/',
            'url_upload_image_product' => 'https://tools.cadeau-maestro.com/faulty/',
            ...
            'iq2i_prestashop_web_service.url' => 'http://www.cadeau-maestro.com',
