...
class __TwigTemplate_044d89e3896269fa626ceb798f5dcbdc98140d3373f4107de2a3eb1b629db379 extends Twig_Template
{
    ...
    <div role=\"tabpanel\">
        ...
        echo "</p>
                ...
                <div class=\"group\">
                    ...
                    <p>";
        // line 38
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["app"] ?? null), "user", array()), "mail", array()), "html", null, true);
        echo "</p>
                </div>
            ...
            <div role=\"tabpanel\" class=\"tab-pane\" id=\"modifier\">
                ...
                ";
        // line 47
        echo         $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->renderBlock(($context["formChangePersonalData"] ?? null), 'form');
        echo "
                ...
                ";
        // line 51
        echo         $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->renderBlock(($context["formChangePassword"] ?? null), 'form');
        echo "
...
";
    ...
    {
        return new Twig_Source("", "UserBundle:User:profil.html.twig", "C:\\Users\\Okaou\\Downloads\\SAVE1\\CM_tools_save\\vendor\\unicorn\\user-bundle\\Unicorn\\Bundle\\UserBundle/Resources/views/User/profil.html.twig");
    }
}
