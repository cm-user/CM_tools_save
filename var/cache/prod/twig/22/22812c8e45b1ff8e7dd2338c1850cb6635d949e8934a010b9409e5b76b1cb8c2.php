...
class __TwigTemplate_b84ad8c8abf976710391237fd231d5a9542a1cfd3f4d884573799311254de240 extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["supplier"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                if (($this->getAttribute($this->getAttribute($context["product"], "faulty", array()), "status", array()) != "refunded")) {
                    ...
                    // line 13
                    echo "                        ";
                    $context["supplierNotRefundedNotEmpty"] = ((isset($context["supplierNotRefundedNotEmpty"]) ? $context["supplierNotRefundedNotEmpty"] : null) + 1);
                    // line 14
                    echo "                        ";
                    // line 15
                    echo "                        ";
                    if (((isset($context["supplierNotRefundedNotEmpty"]) ? $context["supplierNotRefundedNotEmpty"] : null) == 1)) {
                        // line 16
                        echo "                            <h1 id=\"";
    ...
    {
        return new Twig_Source("", "@FaultyProduct/supplier/camalo.html.twig", "/home/cadeau-maestro/tools/src/FaultyProductBundle/Resources/views/supplier/camalo.html.twig");
    }
}
