 ...
 */
class User extends \FaultyProductBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'faultys', 'id', 'username', 'password', 'roles', 'name', 'surname', 'mail', 'salt', 'token', 'active', 'createdAt', 'updatedAt', 'deletedAt'];
        }
    ...
    public function getSystemRoles()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSystemRoles', []);

        return parent::getSystemRoles();
    }
